...
* ROUGH CHECK OF DATA LINES
* DATA LINES COULD STILL HAVE SHORTS BUT UNLIKELY SINCE PINS ARE ADJACENT
STARTTEST:
	MOVE.L  #RAMSTART,%A0
	MOVE.B  #0x55,%D0
	MOVE.B	%D0,(%A0)
...
* WRITE AN INCREMENTING VALUE EVERY 4096 BYTES
* ALSO GOOD CHECK OF DATA LINES SINCE IT VERIFIES THERE ARE NO SHORTS
    MOVE.B  #0X00,%D0
	MOVE.L  #RAMSTART,%A0
	MOVE.L  #RAMEND+1,%A1
FILL4K:
...
* A12-A19 = 0
* WRITE AN INCREMENTING VALUE EVERY 256 BYTES
...
* CHECKS THE REMAINING BOTTOM 256 ADDRESSES AND ALL DATA LINES
* TOKEN EFFORT TO TOUCH ALL LOCATIONS
* DOES NOT DETECT INDIVIDUAL STUCK AT HIGH OR LOW BITS NECESSARILY
    MOVE.B  #0X00,%D0
	MOVE.L  #RAMSTART,%A0
	MOVE.L  #RAMEND+1,%A1
CHKALL:
